...
const inventors = [
  ...
  const  yearsLived = inventors.reduce((prev, next) => {
  ...
  console.log(`Inventors lived ${yearsLived} years.`);
    ...
    //THEORY
    //category.querySelectorAll('a') gives us a nodelist
    //To change nodelist into array we can:
    //1. Array.from(document.querySelectorAll('a'));
    //2. use [...spread ]: [...document.querySelectorAll('a')]

    //SOLUTION TO RUN ON WIKIPEDIA PAGE
  ...
  console.log(`People sorted by Last name: ${sortedPeople}`);
// 8. Reduce Exercise
